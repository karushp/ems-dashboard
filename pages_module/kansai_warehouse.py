...
def load_data():
    """Load Kansai warehouse data"""
    try:
        df = pd.read_parquet("data/processed/kansai_warehouse.parquet")
        return df
...
def kansai_warehouse_page():
    st.title("Kansai Warehouse Energy Dashboard")
    st.markdown("---")
    ...
    with tab1:
        ...
        st.plotly_chart(fig_hourly, width="stretch", key="kansai_warehouse_chart_1")
    ...
    with tab2:
        ...
        with col1:
            ...
            if floor_area_cols:
                ...
                st.plotly_chart(
                    fig_floor, width="stretch", key="kansai_warehouse_chart_2"
                )
        ...
        with col2:
            ...
            if contract_cols:
                ...
                st.plotly_chart(
                    fig_contract, width="stretch", key="kansai_warehouse_chart_3"
                )
    ...
    with tab3:
        ...
        if available_cols:
            ...
            st.plotly_chart(fig_energy, width="stretch", key="kansai_warehouse_chart_4")
            ...
            st.plotly_chart(fig_ts, width="stretch", key="kansai_warehouse_chart_5")
    ...
    with tab4:
        ...
        if "load_signature_class" in df.columns:
            ...
            st.plotly_chart(
                fig_signature, width="stretch", key="kansai_warehouse_chart_6"
            )
        ...
        if "cluster_class" in df.columns:
            ...
            st.plotly_chart(
                fig_cluster, width="stretch", key="kansai_warehouse_chart_7"
            )
