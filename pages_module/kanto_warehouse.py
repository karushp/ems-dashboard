...
def load_data():
    """Load Kanto warehouse data"""
    try:
        df = pd.read_parquet("data/processed/kanto_warehouse.parquet")
        return df
...
def kanto_warehouse_page():
    st.title("Kanto Warehouse Energy Dashboard")
    st.markdown("---")
    ...
    with tab1:
        ...
        display_time_series_section(df, time_aggregation, "Kanto")

        # Hourly pattern
        fig_hourly = create_hourly_pattern_chart(df, "Kanto")
        st.plotly_chart(fig_hourly, width="stretch", key="kanto_warehouse_chart_1")
    ...
    with tab2:
        ...
        with col1:
            ...
            if floor_area_cols:
                ...
                st.plotly_chart(
                    fig_floor, width="stretch", key="kanto_warehouse_chart_2"
                )
        ...
        with col2:
            ...
            if contract_cols:
                ...
                st.plotly_chart(
                    fig_contract, width="stretch", key="kanto_warehouse_chart_3"
                )
    ...
    with tab3:
        ...
        if available_cols:
            ...
            st.plotly_chart(fig_energy, width="stretch", key="kanto_warehouse_chart_4")
            ...
            st.plotly_chart(fig_ts, width="stretch", key="kanto_warehouse_chart_5")
    ...
    with tab4:
        ...
        if "load_signature_class" in df.columns:
            ...
            st.plotly_chart(
                fig_signature, width="stretch", key="kanto_warehouse_chart_6"
            )
        ...
        if "cluster_class" in df.columns:
            ...
            st.plotly_chart(fig_cluster, width="stretch", key="kanto_warehouse_chart_7")
